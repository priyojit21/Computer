        ...
        <div className="bg-black">
            ...
            >
                ...
                <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="rounded-md border border-white-800 bg-neutral-900/50 p-8 text-center shadow transform transition-transform duration-300 hover:scale-105 cursor-pointer">
                        <div
                        ...
                        <h3 className="mt-6 text-gray-400">Expert Guidance</h3>
                    ...
                    <div className="rounded-md border border-white-800 bg-neutral-900/50 p-8 text-center shadow transform transition-transform duration-300 hover:scale-105 cursor-pointer">
                        ...
                        <h3 className="mt-6 text-gray-400">Comprehensive Course Curriculum</h3>
                        <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
                    ...
                    <div className="rounded-md border border-white-800 bg-neutral-900/50 p-8 text-center shadow transform transition-transform duration-300 hover:scale-105 cursor-pointer">
                        ...
                        <h3 className="mt-6 text-gray-400">Job Assistance</h3>
                        <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
