...
export default function Footer() {
  return (
    <footer className="bg-gray-800 py-8 px-8 font-[sans-serif] tracking-wide mt-24">
  <div className="relative">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 pt-10">
      ...
      <div>
        <h4 className="text-xl font-semibold mb-6 text-white">Courses</h4>
  ...
  <div className="bg-gray-900 py-4 px-4 -mx-8 text-center mt-10">
    <p className="text-gray-400 text-base">
      © Computer Plaza Education Soceity. All rights reserved.
    </p>
  </div>
</footer>
